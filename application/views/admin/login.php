...
<!-- Custom CSS -->
<link href="<?php echo base_url(); ?>optimum/css/buy_sell.css" rel="stylesheet">
<!-- color CSS -->
    ...
    <div class="white-box">
               ...
               <div align="center">
				...
				<img  width="100" height="100" src="<?php echo base_url(); ?>optimum/logo.png">
                    <br><br>
					Welcome to<br> <strong style="color:green">Codeigniter Admin Panel</strong>. Click on login button to login.
                <div align="center">
